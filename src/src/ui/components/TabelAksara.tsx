...
const EXAMPLES: Record<string, { jv: string, la: string, id: string, en: string, desc?: string }> = {
  ...
  // Pasangan
  'ha.pas': { jv: 'ꦲꦶꦭ꧀ꦲꦩ꧀', la: 'ilham', id: 'ilham', en: 'inspiration' },
  'na.pas': { jv: 'ꦩꦏ꧀ꦤ', la: 'makna', id: 'makna', en: 'meaning' },
  'ca.pas': { jv: 'ꦏꦤ꧀ꦕ', la: 'kanca', id: 'teman', en: 'friend' },
  'ra.pas': { jv: 'ꦥꦱ꧀ꦫꦃ', la: 'pasrah', id: 'pasrah', en: 'surrender' },
  'ka.pas': { jv: 'ꦮꦱ꧀ꦏꦶꦠ', la: 'waskita', id: 'bijaksana', en: 'wise' },
  'da.pas': { jv: 'ꦱꦤ꧀ꦢꦭ꧀', la: 'sandal', id: 'sandal', en: 'sandal' },
  'ta.pas': { jv: 'ꦥꦸꦱ꧀ꦠꦏ', la: 'pustaka', id: 'buku', en: 'book' },
  'sa.pas': { jv: 'ꦥꦼꦏ꧀ꦱ', la: 'peksa', id: 'paksa', en: 'force' },
  'wa.pas': { jv: 'ꦱ꧀ꦮꦫ', la: 'swara', id: 'suara', en: 'voice' },
  'la.pas': { jv: 'ꦱ꧀ꦭꦩꦼꦠ꧀', la: 'slamet', id: "selamat", en: "safe" },
  'pa.pas': { jv: 'ꦠꦤ꧀ꦥ', la: 'tanpa', id: 'tanpa', en: 'without' },
  'dha.pas': { jv: 'ꦏꦤ꧀ꦝ', la: 'kandha', id: 'berkata', en: 'say' },
  'ja.pas': { jv: 'ꦧꦤ꧀ꦗꦶꦂ', la: 'banjir', id: 'banjir', en: 'flood' },
  'ya.pas': { jv: 'ꦱꦼꦠ꧀ꦪ', la: 'setya', id: 'setia', en: 'loyal' },
  'nya.pas': { jv: 'ꦮꦶꦒ꧀ꦚ', la: 'wignya', id: 'pandai', en: 'clever' },
  'ma.pas': { jv: 'ꦱꦸꦏ꧀ꦩ', la: 'sukma', id: 'jiwa', en: 'soul' },
  'ga.pas': { jv: 'ꦔ꧀ꦒꦶꦃ', la: 'nggih', id: 'ya', en: 'yes' },
  'ba.pas': { jv: 'ꦏꦼꦩ꧀ꦧꦂ', la: 'kembar', id: 'kembar', en: 'twin' },
  'tha.pas': { jv: 'ꦏꦤ꧀ꦛꦶ', la: 'kanthi', id: 'dengan', en: 'with' },
  'nga.pas': { jv: 'ꦢꦏ꧀ꦔꦥꦸꦫ', la: 'dakngapura', id: 'kumaafkan', en: 'I forgive' },
