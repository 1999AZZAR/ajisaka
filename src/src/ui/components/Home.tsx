...
export default function Home() {
  ...
  return (
    <>
      <main className="relative flex h-full overflow-hidden flex-col items-center justify-center overflow-hidden bg-gradient-to-b from-paper to-[oklch(0.95_0.02_78)] px-6 py-10">
          ...
          <div className="relative flex flex-col items-center gap-6 overflow-hidden rounded-[2.5rem] border-4 border-white/80 bg-white/60 p-10 text-center shadow-[0_12px_40px_rgba(0,0,0,0.08)] backdrop-blur-xl transition-transform">
            ...
            <div className="mt-4 flex flex-col items-center gap-3 w-full">
              ...
              {isInstallable && (
                <button 
                  onClick={install}
                  className="w-full sm:w-64 rounded-3xl bg-white/50 px-8 py-4 font-display text-xl tracking-wide text-accent border-2 border-accent/20 shadow-sm transition-all hover:bg-white/80"
                >
                  {t('app.home.install')}
                </button>
              )}
